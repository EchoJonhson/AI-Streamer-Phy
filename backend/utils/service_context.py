...
注意: 这是从 src/open_llm_vtuber/service_context.py 迁移的临时版本
大部分导入已注释掉，等待后续重构阶段完成相关模块的迁移后再启用
"""
...
# 暂时注释掉不存在的导入，等待后续重构阶段处理
# from prompts import prompt_loader
# from ..live2d.live2d_model import Live2dModel
# from ..ai.asr.asr_interface import ASRInterface
# from ..voice.tts_interface import TTSInterface
# from ..ai.vad.vad_interface import VADInterface
# from ..ai.agent.agents.agent_interface import AgentInterface
# from ..ai.translate.translate_interface import TranslateInterface

# from ..ai.asr.asr_factory import ASRFactory
# from ..voice.tts_factory import TTSFactory
# from ..ai.vad.vad_factory import VADFactory
